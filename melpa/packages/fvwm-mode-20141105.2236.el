...
;;
;; Thanks to Scott Andrew Borton for his excellent major mode
;;  tutorial, to Thomas Adam for providing his vim syntax file for
;;  Fvwm which was a great help in creating this mode and many others
;;  in the Emacs and Fvwm communities.
;; 
