;;; kooten-theme.el --- Dark color theme

;; Copyright (C) 2015 Pascal van Kooten

;; Author: Pascal van Kooten <kootenpv@gmail.com>
;; Keywords: themes
;; Package-Version: 20151228.1026
...
;; THIS THEME HAS JUST OVERWRITTEN COLORS FROM THE FOLLOWING PEOPLE:
...
;; Finally, based on Ozan Sener's afternoon theme:
;; http://github.com/osener/emacs-afternoon-theme

;; PASCAL VAN KOOTEN SIMPLY CHANGED THE COLORS TO HIS LIKING.
...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-constant-face ((,class (:foreground "#969896"))))
   ...
   `(font-lock-type-face ((,class (:foreground "coral1"))))
   ...
   ;; IDO
   `(ido-subdir ((,class (:foreground ,orange))))
   ...
   `(magit-log-head-label-local ((,class (:foreground ,orange :box nil :weight bold))))
   `(magit-log-head-label-remote ((,class (:foreground ,orange :box nil :weight bold))))
   ...
   `(org-table ((,class (:foreground ,orange))))
   ...
   `(coffee-mode-function-param ((,class (:foreground ,orange))))
   ...
   `(jabber-roster-user-chatty ((,class (:foreground ,orange))))
   ...
   `(jabber-activity-face ((,class (:foreground ,orange))))
   ...
   `(ledger-font-posting-account-face ((,class (:foreground ,orange))))
   ...
   `(erc-nick-default-face ((,class (:weight normal :foreground ,orange))))
   ...
   `(term-color-magenta ((,class (:foreground ,orange :background ,orange))))
  ...
  (custom-theme-set-variables
   ...
   `(ansi-color-names-vector (vector ,foreground ,red ,green ,yellow ,blue ,orange ,aqua ,background))
