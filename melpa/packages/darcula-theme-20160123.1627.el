...
(custom-theme-set-faces
 ...
 '(ediff-current-diff-A ((t (:background "#242424"))))
 '(ediff-current-diff-B ((t (:background "#242424"))))
 '(ediff-current-diff-C ((t (:background "#242424"))))
 '(ediff-fine-diff-A ((t (:background "#46382c"))))
 '(ediff-fine-diff-B ((t (:background "#343d32"))))
 '(ediff-fine-diff-C ((t (:background "#313939"))))
