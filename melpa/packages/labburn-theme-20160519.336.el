...
;;;;; dired+
 ...
 `(diredp-date-time ((t (:foreground ,labburn-magenta))))
 `(diredp-deletion ((t (:foreground ,labburn-yellow))))
 `(diredp-deletion-file-name ((t (:foreground ,labburn-red))))
 `(diredp-dir-heading ((t (:foreground ,labburn-blue :background ,labburn-bg-1))))
 `(diredp-dir-priv ((t (:foreground ,labburn-cyan))))
 `(diredp-exec-priv ((t (:foreground ,labburn-red))))
 `(diredp-executable-tag ((t (:foreground ,labburn-green+1))))
 `(diredp-file-name ((t (:foreground ,labburn-blue))))
 `(diredp-file-suffix ((t (:foreground ,labburn-green))))
 `(diredp-flag-mark ((t (:foreground ,labburn-yellow))))
 `(diredp-flag-mark-line ((t (:foreground ,labburn-orange))))
 `(diredp-ignored-file-name ((t (:foreground ,labburn-red))))
 `(diredp-link-priv ((t (:foreground ,labburn-yellow))))
 `(diredp-mode-line-flagged ((t (:foreground ,labburn-yellow))))
 `(diredp-mode-line-marked ((t (:foreground ,labburn-orange))))
 `(diredp-no-priv ((t (:foreground ,labburn-fg))))
 `(diredp-number ((t (:foreground ,labburn-green+1))))
 `(diredp-other-priv ((t (:foreground ,labburn-yellow-1))))
 `(diredp-rare-priv ((t (:foreground ,labburn-red-1))))
 `(diredp-read-priv ((t (:foreground ,labburn-green-1))))
 `(diredp-symlink ((t (:foreground ,labburn-yellow))))
 `(diredp-write-priv ((t (:foreground ,labburn-magenta))))
