...
for /F %%A IN ('dir /b %CLRInstallDir%\v3.5*') DO @SET v35CLRInstallDir=%CLRInstallDir%%%A
if not exist "%v35CLRInstallDir%" echo Warning: The CLR v3.5 directory %v35CLRInstallDir% does not exist
...
set Path=%SdmToolsDir%;%V35CLRInstallDir%;%Path%
