...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 257))) ;;
        ;;                                        DARK      LIGHT
        (base          (if (eq variant 'dark)   "#E8DACC" "#444444" ))
        (base2         (if (eq variant 'dark)   "#5D5147" "#ADA190" ))
        (base3         (if (eq variant 'dark)   "#D7D9D0" "#5FAF87" ))
        (cursor        (if (eq variant 'dark)   "#917154" "#806C5B" ))
        (bg1           (if (eq variant 'dark)   "#1c1c1c" "#FFEFDB" ))
        (bg2           (if (eq variant 'dark)   "#262626" "#EEDFCC" ))
        (bg3           (if (eq variant 'dark)   "#333333" "#E5D5C1" ))
        (bg4           (if (eq variant 'dark)   "#6F6F6F" "#ADA790" ))
        (key1          (if (eq variant 'dark)   "#D66F84" "#A33555" ))
        (key2          (if (eq variant 'dark)   "#D4B292" "#616960" ))
        (builtin       (if (eq variant 'dark)   "#9C8772" "#84745C" ))
        (keyword       (if (eq variant 'dark)   "#D75F87" "#D75F87" ))
        (const         (if (eq variant 'dark)   "#D49A8A" "#666E4D" ))
        (comment       (if (eq variant 'dark)   "#707070" "#979987" ))
        (func          (if (eq variant 'dark)   "#D79887" "#AE6A56" ))
        (str           (if (eq variant 'dark)   "#9DA69E" "#6F756E" ))
        (type          (if (eq variant 'dark)   "#94B1A3" "#375E54" ))
        ...
        (inf           (if (eq variant 'dark)   "#769188" "#6C9889" ))
        (interop       (if (eq variant 'dark)   "#7D6F6A" "#848F86" ))
        (suc           (if (eq variant 'dark)   "#BDC79E" "#96A374" ))
        (green         (if (eq variant 'dark)   "#B9C398" "#666E4D" ))
        (yellow        (if (eq variant 'dark)   "#CC816B" "#D7875F" ))
        (cyan          (if (eq variant 'dark)   "#989584" "#6F756E" ))
        (violet        (if (eq variant 'dark)   "#A8938C" "#5B5040" ))
        ...
        (org-h1-bg     (if (eq variant 'dark)   "#333333" "#FAFAD9" ))
        ...
        (highlight     (if (eq variant 'dark)   "#121212" "#DBCBB7" ))
        ...
        (t-bg1           (if (eq variant 'dark)   "#1C1C1C" "#EEEEEE" ))
        (t-bg2           (if (eq variant 'dark)   "#262626" "#EEEEEE" ))
        (t-bg3           (if (eq variant 'dark)   "#333333" "#DADADA" ))
        ...
        (t-org-h2-bg     (if (eq variant 'dark)   "#333333" "#FFFFD7" ))
        (t-org-h3-bg     (if (eq variant 'dark)   "#3c3c3c" "#FFFFD7" ))
        (t-org-h4-bg     (if (eq variant 'dark)   "#444444" "#FFFFD7" ))
        (t-highlight     (if (eq variant 'dark)   "#121212" "#D0D0D0" ))
...
;;;;; org
     ...
     `(org-agenda-done                           ((,class (:foreground ,(if (eq variant 'dark) suc green) :bold t))
                                                  (,t-class (:foreground ,(if (eq variant 'dark) suc green) :bold t))))
